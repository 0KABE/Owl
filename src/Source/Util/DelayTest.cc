...
Owl::DelayTest::DelayTest(std::string url, Owl::ProxyNode::ProxyPtr proxyPtr)
        : mUrl(std::move(url)), mProxyPtr(std::move(proxyPtr)) {}

Owl::Awaitable<Owl::DelayTest::Delay> Owl::DelayTest::TestDelay(TimeoutEvent::Timeout timeout) {
